...
### 近期工作汇总
 - [ ] 在非弛豫的条件下，计算非磁性VS2、VSe2、VTe2单层原胞在原始层间距下的DOS和能带结构。
 - [ ] 在非弛豫的条件下，计算非磁性VS2、VSe2、VTe2双层原胞在原始层间距下的DOS和能带结构。
 - [ ] 在非弛豫的条件下，计算磁性VTe2单层的磁性基态。
 - [ ] 在非弛豫的条件下，计算磁性VTe2在层间距3.12和3.52条件下的磁性基态。
 - [ ] 对VS2、VTe2非磁双层结构进行结构弛豫。
 - [ ] 研究旋转结构和压缩层间距时，V-Se-V键角的变化。
